        ...
        <div className="container-fluid page-body-wrapper full-page-wrapper">
            ...
            <div className="row flex-grow">
                ...
                <div className="auth-form-light text-left p-5">
                    ...
                    <div className="mt-3">
                        <a className="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">ENTRAR</a>
                    </div>
                    ...
                    <div className="text-center mt-4 font-weight-light"> Ainda não tem uma conta? <a href="register.html" className="text-primary">Criar conta</a>
                    </div>
                    </form>
                </div>
                </div>
